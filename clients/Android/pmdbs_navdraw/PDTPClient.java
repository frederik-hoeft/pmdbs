                                            ...
                                            try{
                                                ...
                                                switch(mode.split("!")[1]){
                                                    ...
                                                    case "INSERT":
                                                        ...
                                                        SyncThreadHelper_HID synchelper_hid = SyncThreadHelper_HID.GetInstance(params);
                                                        Thread t_hid = new Thread(synchelper_hid);
                                                        t_hid.start();
                                            ...
                                            switch (decryptedData.split("!")[1])
                                            {
                                                ...
                                                case "LOGIN_SUCCESSFUL":
                                                    if(!globalVARpool.wasOnline && globalVARpool.loadingType==globalVARpool.LoadingType.none){
                                                        ...
                                                        CustomToast.makeText(globalVARpool.applicationcontext, "Login successful!");
                                                        //TODO MSG=LOGIN SUCCESSFUL!
                                                    }
                                                    logged_in=true;
                                                    break;

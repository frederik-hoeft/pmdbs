    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_onlinelogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    System.out.println("!!!!pw: "+globalVARpool.plainMasterPW);
                    final String pw_hash= CryptoHelper.SHA256(password);
                    System.out.println("!!!!pw_hash: "+pw_hash);

                    System.out.println("!!!!pw_hash/substring: "+pw_hash.substring(0,32));


                    globalVARpool.onlinePassword=CryptoHelper.SHA256(pw_hash.substring(0,32));
                    System.out.println("!!!!onlinepassword: "+globalVARpool.onlinePassword);
                    ...
                    Runnable initializeDB = new Runnable() {
                        ...
                        public void run() {
                            ...
                            db.execSQL(DataBaseHelper.Security.SQLInjectionCheckQuery(new String[]{"UPDATE Tbl_user SET U_password =\"",pw_hash,"\",U_wasOnline = 1, U_firstUsage = \"",firstUsage,"\",U_username =\"",masteruname,"\",U_cookie=\"",globalVARpool.cookie,"\",U_datetime = 0;"}));
                    ...
                    //System.out.println("!!!!!!!!!!!!!!!!!!!!Tbl_settings: "+dbhelper.execSQL("SELECT EXISTS (SELECT 1 FROM Tbl_settings);"));

                    int returnint = Integer.valueOf(dbhelper.execSQL("SELECT EXISTS (SELECT 1 FROM Tbl_settings);"));
                    //System.out.println("!!!!!!!!!!!!!!!!!!!!Tbl_settings: "+returnint);
                    ...
                    if(returnint==1){
                        ...
                        dbhelper.execSQL(DataBaseHelper.Security.SQLInjectionCheckQuery(new String[]{"INSERT INTO Tbl_settings (S_server_ip, S_server_port) VALUES ( \"",ip,"\",\"",str_port,"\");"}));
                    }

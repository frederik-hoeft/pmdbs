...
public class NetworkAdapter
{
    public static class MethodProvider
    {
        ...
        public static void GetAccountDetails()
        {
        	...
        	String datetime = dbHelper.execSQL("SELECT U_datetime FROM Tbl_user LIMIT 1;");
        	if(datetime.equals("")) datetime="0";
        ...
        {
            //SELECT D_id, D_host, D_url, D_uname, D_password, D_email, D_notes, D_icon, D_hid, D_datetime FROM Tbl_data WHERE D_id = ",id," LIMIT 1;
            ...
            System.out.println("SYNC -> QUERY: "+query);
